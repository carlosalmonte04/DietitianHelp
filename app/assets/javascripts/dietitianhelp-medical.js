...
function rchart0() {
  ...
  const significantWeightLoss = (loss) =>
    significantLossOneMonth ||
    significantLossThreeMonths ||
    significantLossSixMonths;
  const significantWeightGain = (gain) =>
    significantGainOneMonth ||
    significantGainThreeMonths ||
    signficantGainSixMonths;
