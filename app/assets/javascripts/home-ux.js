$(document).ready(function () {
  ...
  $("#select-beast-landsearch-selectized").keyup(function () {
    ...
    if (
      $("#landsearch-dropdown:first-child div").attr("class") == "create active"
    ) {
      $("#landsearchicon").attr(
        "class",
        "fa fa-stack-1x fa-inverse fa-user-plus",
      );
    }
  });
  ...
  $.ajax({
    ...
    success: function (data) {
      top.document
        ...
        .contentDocument.getElementById("clientloadright").innerHTML = data;
    },
  });
}
